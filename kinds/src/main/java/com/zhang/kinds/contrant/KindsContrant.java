...
//    }
//    abstract class kindsRepository extends BaseRepository<KindsModel>{
//        public abstract Observable<KindsEntitiy> reqKinds();
//    }
//    abstract class KindsPresenter extends BasePresenter<KindsContrant.kindsRepository,KindsView>{
//        public KindsPresenter(kindsRepository repository, KindsView vView) {
