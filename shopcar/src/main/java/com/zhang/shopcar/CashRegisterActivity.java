...
import com.zhang.shopcar.pay.PayResult;
import com.zhang.shopcar.pay.util.OrderInfoUtil2_0;
...
public class CashRegisterActivity extends AppCompatActivity {
    ...
    private TextView mWeixinTypeTv;
    private TextView mBankCardTypeTv;
    private Button pay;
    /**
     * 用于支付宝支付业务的入参 app_id。
     */
    public static final String APPID = "2021000117666894";
    ...
    public static final String RSA_PRIVATE = "";
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(CashRegisterActivity.this, "支付成功!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(CashRegisterActivity.this, DetailActivity.class));
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(CashRegisterActivity.this, "支付失败,请重新支付!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    break;
                }
    ...
    private void initData() {
        int momey = getIntent().getIntExtra("money", 0);
        if (momey>0){
            mTotalPriceTv.setText("商品金额为:"+momey);
        }
        mAlipayTypeTv.setOnClickListener(view->{
            OrderInfoUtil2_0.money = momey;//money是double类型
    ...
    private void initView() {
        mTotalPriceTv = (TextView) findViewById(R.id.mTotalPriceTv);
        mAlipayTypeTv = (TextView) findViewById(R.id.mAlipayTypeTv);
        mWeixinTypeTv = (TextView) findViewById(R.id.mWeixinTypeTv);
        mBankCardTypeTv = (TextView) findViewById(R.id.mBankCardTypeTv);
    }
    ...
    public void payV2() {
        ...
        final Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(CashRegisterActivity.this);
